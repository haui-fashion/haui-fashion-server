...
export class GeminiImageService {
  ...
  private buildVtonPrompt(garmentType?: string, productName?: string): string {
    ...
    return [
      ...
      '',
      'INPUT:',
      '- Hình ảnh thứ nhất: ảnh sản phẩm tham chiếu (garment source)',
      '- Hình ảnh thứ hai: ảnh người mẫu đích (target person)',
      '',
      ...
      '',
      'NGUYÊN TẮC:',
      `- Kiểm tra xem đúng ${productName} (nếu được cung cấp) có xuất hiện trong hình ảnh sản phẩm hay không. Nếu có, hãy tập trung ghép thử đồ dựa trên item đó. Nếu không, hãy xác định item chính trong ảnh sản phẩm để ghép thử đồ.`,
      '- GIỮ NGUYÊN hoàn toàn khuôn mặt, vóc dáng, màu da, kiểu tóc và tư thế của người mẫu (hình ảnh thứ hai).',
